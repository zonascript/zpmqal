...
class TbtqHotelModel extends Model
{
	...
	*/
	...
	{
		return $this->belongsTo('App\Models\Api\TbtqHotelRoomModel', 'tbtq_hotel_room_id');		
	}

	public function tbtqDetail()
	{
		return $this->belongsTo('App\Models\Api\TbtqHotelDetailModel', 'tbtq_hotel_detail_id');		
	}
