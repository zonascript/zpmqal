		...
		<div class="page-title">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-12">
					<a href="{{ url('dashboard/inventories/activity') }}" class="btn btn-success btn-block"><i class="fa fa-arrow-left"></i> Back to Activity</a>
				</div>
			</div>
		</div>
						...
						<div class="x_content" >
							...
							<div class="row m-top-20">
								@foreach ($activity->images as $image)
									<div class="col-md-55">
										<div class="thumbnail height-auto">
