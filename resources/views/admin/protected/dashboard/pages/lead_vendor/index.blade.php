		...
		<div class="page-title">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-12">
					<a href="{{ url('dashboard/settings/lead/vendor/create') }}" class="btn btn-success btn-block">Add Vendor</a>
				</div>
				<div class="col-md-4 col-sm-7 col-xs-12 text-center">
					<h3>Lead Vendor List</h3>
				</div>
				<div class="col-md-5 col-sm-8 col-xs-12 form-group pull-right top_search">
					<form action="{{ url('dashboard/settings/lead/vendor') }}" method="head">
						...
						<div class="row">
							@forelse($vendors as $vendor)
								<div class="col-md-4 col-sm-4 col-xs-12 profile_details">
									<div class="well profile_view {{ $vendor->status == 'inactive' ? 'border-red' : '' }}">
										<div class="col-sm-12">
										...
										<div class="col-xs-12 bottom text-center">
											<div class="col-md-4 col-sm-4 col-xs-12">
												<a href="{{ url('dashboard/settings/lead/vendor/'.$vendor->id) }}" class="btn btn-primary btn-xs font-size-15">View Profile
												</a>
											</div>
											<div class="col-md-3 col-sm-3 col-xs-12">
												@if ($vendor->status == 'inactive')
													<form method="POST" action="{{url('dashboard/settings/lead/vendor/'.$vendor->id).'/active'}}">
	                          {{ method_field('POST') }}
	                          {{ csrf_field() }}
