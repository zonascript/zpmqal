...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:35:48 GMT -->
<head>
...
<body>
    ...
    <div class="global-wrap">
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/aboutc392.html?default=true" style="background:#ED8323;"></a>
                    ...
                    <ul class="slimmenu" id="slimmenu">
                        ...
                        <li class="active"><a href="{{ url('traveler') }}/success-payment.html">Pages</a>
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/about.html">About</a>
                                </li>
        ...
        <div class="container">
            ...
            <div class="row row-wrap" data-gutter="60">
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/amaze_300x300.jpg" alt="Image Alternative text" title="AMaze" />
                        </header>
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/chiara_300x300.jpg" alt="Image Alternative text" title="Chiara" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/bubbles_300x300.jpg" alt="Image Alternative text" title="Bubbles" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/gamer_chick_300x300.jpg" alt="Image Alternative text" title="Gamer Chick" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/afro_300x300.jpg" alt="Image Alternative text" title="Afro" />
                        </header>
                        <div class="thumb-caption">
                            <h5 class="thumb-title">Oliver Ross</h5>
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/me_with_the_uke_300x300.jpg" alt="Image Alternative text" title="Me with the Uke" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/andrea_300x300.jpg" alt="Image Alternative text" title="Andrea" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ url('traveler') }}/img/spidy_300x300.jpg" alt="Image Alternative text" title="Spidy" />
                        </header>
                        <div class="thumb-caption">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <a href="{{ url('traveler') }}/#">Explore open positions</a>
                </div>
            </div>
            <div class="gap"></div>
        ...
        <div class="row row-no-gutter">
            <div class="col-md-3">
                <img src="{{ url('traveler') }}/img/the_big_showoff-take_2_800x600.jpg" alt="Image Alternative text" title="The Big Showoff-Take 2" />
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <img src="{{ url('traveler') }}/img/playstation_controller_800x600.jpg" alt="Image Alternative text" title="Playstation controller" />
            </div>
            <div class="col-md-3">
                <img src="{{ url('traveler') }}/img/branding__ipad_interactive_design_800x600.jpg" alt="Image Alternative text" title="Branding  iPad Interactive Design" />
            </div>
            <div class="col-md-3">
                <img src="{{ url('traveler') }}/img/old_no7_800x600.jpg" alt="Image Alternative text" title="Old No7" />
            </div>
            <div class="col-md-3">
                <img src="{{ url('traveler') }}/img/going_out_tonight_800x600.jpg" alt="Image Alternative text" title="Going out tonight" />
            </div>
            <div class="col-md-3">
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:36:46 GMT -->
</html>
