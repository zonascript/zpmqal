...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/hotel-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:41:16 GMT -->
<head>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/hotel-paymentc392.html?default=true" style="background:#ED8323;"></a>
                        ...
                        <li class="active"><a href="{{ url('traveler') }}/hotels.html">Hotels</a>
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/hotel-payment.html">Payment</a>
                                    <ul>
                                        <li class="active"><a href="{{ url('traveler') }}/hotel-payment.html">Registered</a>
                                        </li>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/hotel-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:41:29 GMT -->
</html>
