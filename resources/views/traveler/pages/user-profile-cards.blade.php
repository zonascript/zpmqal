...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:31:37 GMT -->
<head>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/user-profile-cardsc392.html?default=true" style="background:#ED8323;"></a>
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/user-profile.html">User Profile</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ url('traveler') }}/user-profile-cards.html">Cards</a>
                                        </li>
                    ...
                    <div class="row row-wrap">
                        <div class="col-md-4">
                            <div class="card-thumb">
                                <ul class="card-thumb-actions">
                                    <li>
                                        <a class="fa fa-pencil popup-text" href="{{ url('traveler') }}/#edit-card-dialog" rel="tooltip" data-placement="top" title="edit" data-effect="mfp-zoom-out"></a>
                                    </li>
                                    <li>
                                        <a class="fa fa-times" href="{{ url('traveler') }}/#" rel="tooltip" data-placement="top" title="remove"></a>
                                    </li>
                                </ul>
                                <p class="card-thumb-number">XXXX XXX XXXX 5622</p>
                                <p class="card-thumb-valid">valid thru <span>8 / 18</span>
                                </p>
                                <img class="card-thumb-type" src="{{ url('traveler') }}/img/payment/mastercard-curved-32px.png" alt="Image Alternative text" title="Image Title" /><small>cardholder name</small>
                        ...
                        <div class="col-md-4">
                            <div class="card-thumb">
                                ...
                                <img class="card-thumb-type" src="{{ url('traveler') }}/img/payment/american-express-curved-32px.png" alt="Image Alternative text" title="Image Title" /><small>cardholder name</small>
                                <h5 class="uc">John Doe</h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-thumb">
                                ...
                                <img class="card-thumb-type" src="{{ url('traveler') }}/img/payment/visa-curved-32px.png" alt="Image Alternative text" title="Image Title" /><small>cardholder name</small>
                                <h5 class="uc">John Doe</h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4"><a class="card-thumb popup-text" href="{{ url('traveler') }}/#new-card-dialog" data-effect="mfp-zoom-out"><i class="fa fa-plus card-thumb-new"></i><p >add new card</p></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:32:02 GMT -->
</html>
