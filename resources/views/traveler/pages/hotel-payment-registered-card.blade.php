...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/hotel-payment-registered-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:41:29 GMT -->
<head>
    <title>Traveler - Hotel payment registered card</title>
...
<body>
    ...
    <div class="global-wrap">
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/hotel-payment-registered-cardc392.html?default=true" style="background:#ED8323;"></a>
                    ...
                    <ul class="slimmenu" id="slimmenu">
                        ...
                        <li class="active"><a href="{{ url('traveler') }}/hotels.html">Hotels</a>
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/hotel-payment.html">Payment</a>
                                    <ul>
                                        <li><a href="{{ url('traveler') }}/hotel-payment.html">Registered</a>
                                        </li>
                                        <li class="active"><a href="{{ url('traveler') }}/hotel-payment-registered-card.html">Existed Cards</a>
                                        </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img class="pp-img" src="{{ url('traveler') }}/img/paypal.png" alt="Image Alternative text" title="Image Title" />
                ...
                <div class="col-md-4">
                    ...
                    <ul class="card-select">
                        <li>
                            <img class="card-select-img" src="{{ url('traveler') }}/img/payment/visa-curved-64px.png" alt="Image Alternative text" title="Image Title" />
                        ...
                        <li>
                            <img class="card-select-img" src="{{ url('traveler') }}/img/payment/maestro-curved-64px.png" alt="Image Alternative text" title="Image Title" />
                            <div class="card-select-data">
                ...
                <div class="col-md-4">
                    <div class="booking-item-payment">
                        <header class="clearfix">
                            <a class="booking-item-payment-img" href="{{ url('traveler') }}/#">
                                <img src="{{ url('traveler') }}/img/hotel_1_800x600.jpg" alt="Image Alternative text" title="hotel 1" />
                            </a>
                            <h5 class="booking-item-payment-title"><a href="{{ url('traveler') }}/#">InterContinental New York Barclay</a></h5>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/hotel-payment-registered-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:41:48 GMT -->
</html>
