...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:32:02 GMT -->
<head>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/user-profile-wishlistc392.html?default=true" style="background:#ED8323;"></a>
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/user-profile.html">User Profile</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ url('traveler') }}/user-profile-wishlist.html">Wishlist</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="col-md-9">
                    <ul class="booking-list booking-list-wishlist">
                        <li><span class="booking-item-wishlist-title"><i class="fa fa-bolt"></i> activity <span >added on July 15, 2014</span></span>
                            <a class="fa fa-times booking-item-wishlist-remove" href="{{ url('traveler') }}/#" rel="tooltip" data-placement="top" title="remove from wishlist"></a>
                            <a class="booking-item" href="{{ url('traveler') }}/#">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="{{ url('traveler') }}/img/street_yoga_800x600.jpg" alt="Image Alternative text" title="Street Yoga" />
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <li><span class="booking-item-wishlist-title"><i class="fa fa-home"></i> vacation rental <span >added on July 15, 2014</span></span>
                            ...
                            <a class="booking-item" href="{{ url('traveler') }}/#">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-img-wrap">
                                            <img src="{{ url('traveler') }}/img/hotel_porto_bay_rio_internacional_rooftop_pool_800x600.jpg" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL rooftop pool" />
                                            <div class="booking-item-img-num"><i class="fa fa-picture-o"></i>11</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:32:22 GMT -->
</html>
