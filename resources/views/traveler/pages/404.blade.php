...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:35:21 GMT -->
<head>
    ...
    <div class="global-wrap">
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/404c392.html?default=true" style="background:#ED8323;"></a>
        ...
        <div class="full-page">
            <div class="bg-holder full">
                ...
                <div class="bg-blur" style="background-image:url(img/196_365_1300x900.jpg);"></div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <p>Litora lacinia diam pharetra tristique litora netus mus enim ultricies ridiculus metus non adipiscing natoque mus nam luctus fringilla consectetur</p><a class="btn btn-white btn-ghost btn-lg mt5" href="{{ url('traveler') }}/index-2.html"><i class="fa fa-long-arrow-left"></i> to Homepage</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="footer-links">
                        <li><a href="{{ url('traveler') }}/#">About</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Help</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Hot Deals</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Popular Locations</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Cheap Flights</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Business</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Media</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Developers</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">Advertise</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:35:42 GMT -->
</html>
