...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-photos.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:30:07 GMT -->
<head>
    <title>Traveler - Travel Photos</title>
    ...
    <div class="global-wrap">
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/user-profile-photosc392.html?default=true" style="background:#ED8323;"></a>
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/user-profile.html">User Profile</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ url('traveler') }}/user-profile-photos.html">Photos</a>
                                        </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <a href="{{ url('traveler') }}/#" class="btn btn-primary mb20"><i class="fa fa-plus-circle"></i> Add new photo</a>
                    <div class="row row-no-gutter">
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/the_journey_home_400x300.jpg" alt="Image Alternative text" title="the journey home" />
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/people_on_the_beach_800x600.jpg" alt="Image Alternative text" title="people on the beach" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/4_strokes_of_fun_800x600.jpg" alt="Image Alternative text" title="4 Strokes of Fun" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/pictures_at_the_museum_800x600.jpg" alt="Image Alternative text" title="Pictures at the museum" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/new_york_at_an_angle_800x600.jpg" alt="Image Alternative text" title="new york at an angle" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/bridge_800x600.jpg" alt="Image Alternative text" title="Bridge" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/the_hidden_power_of_the_heart_800x600.jpg" alt="Image Alternative text" title="The Hidden Power of the Heart" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/plunklock_live_in_cologne_800x600.jpg" alt="Image Alternative text" title="Plunklock live in Cologne" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/fly_away_800x600.jpg" alt="Image Alternative text" title="Fly away" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/pizza_hut_800x600.jpg" alt="Image Alternative text" title="Pizza Hut" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                        ...
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{ url('traveler') }}/#">
                                    <img src="{{ url('traveler') }}/img/me_800x600.jpg" alt="Image Alternative text" title="me" />
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-inner-sm hover-hold">
                                        <div class="text-small">
                    ...
                    <ul class="pagination">
                        <li class="active"><a href="{{ url('traveler') }}/#">1</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">2</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">3</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">4</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">5</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">6</a>
                        </li>
                        <li><a href="{{ url('traveler') }}/#">7</a>
                        </li>
                        <li class="dots">...</li>
                        <li><a href="{{ url('traveler') }}/#">43</a>
                        </li>
                        <li class="next"><a href="{{ url('traveler') }}/#">Next Page</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-photos.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:31:30 GMT -->
</html>
