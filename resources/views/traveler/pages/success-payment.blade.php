		...
		<div class="demo_changer" id="demo_changer">
			...
			<div class="form_holder">
				...
				<div class="predefined_styles" id="styleswitch_area">
					<a class="styleswitch" href="{{ url('traveler') }}/success-paymentc392.html?default=true" style="background:#ED8323;"></a>
				...
				<div class="nav">
					<ul class="slimmenu" id="slimmenu">
						...
						<li class="active"><a href="{{ url('traveler') }}/success-payment.html">Pages</a>
							<ul>
								<li class="active"><a href="{{ url('traveler') }}/success-payment.html">Success Payment</a>
								</li>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/success-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:29:59 GMT -->
</html>
