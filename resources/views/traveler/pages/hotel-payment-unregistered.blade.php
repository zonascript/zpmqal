...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/hotel-payment-unregistered.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:41:48 GMT -->
<head>
    <title>Traveler - Hotel payment unregistered</title>
    ...
    <div class="global-wrap">
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/hotel-payment-unregisteredc392.html?default=true" style="background:#ED8323;"></a>
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/hotel-payment.html">Payment</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ url('traveler') }}/hotel-payment-unregistered.html">Unregistered</a>
                                        </li>
                                    </ul>
                                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h3>Customer</h3>
                    <p>Sign in to your <a href="{{ url('traveler') }}/#">Traveler account</a> for fast booking.</p>
                    <form>
                        <div class="row">
                            <div class="col-md-4">
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/hotel-payment-unregistered.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:41:55 GMT -->
</html>
