...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:29:59 GMT -->
<head>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/user-profile-settingsc392.html?default=true" style="background:#ED8323;"></a>
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/user-profile.html">User Profile</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ url('traveler') }}/user-profile-settings.html">Settings</a>
                                        </li>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:30:07 GMT -->
</html>
