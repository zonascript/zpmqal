...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:35:42 GMT -->
<head>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/contact-usc392.html?default=true" style="background:#ED8323;"></a>
                    ...
                    <ul class="slimmenu" id="slimmenu">
                        ...
                        <li class="active"><a href="{{ url('traveler') }}/success-payment.html">Pages</a>
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/contact-us.html">Contact Us</a>
                                </li>
                ...
                <div class="col-md-4">
                    <aside class="sidebar-right">
                        <ul class="address-list list">
                            <li>
                                <h5>Email</h5><a href="{{ url('traveler') }}/#">info@traveler.com</a>
                            </li>
                            <li>
                                <h5>Phone Number</h5><a href="{{ url('traveler') }}/#">+1 (286) 929-1739</a>
                            </li>
                            <li>
                                <h5>Skype</h5><a href="{{ url('traveler') }}/#">contact_traveller</a>
                            </li>
                            <li>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:35:48 GMT -->
</html>
