...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-booking-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:31:30 GMT -->
<head>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="{{ url('traveler') }}/user-profile-booking-historyc392.html?default=true" style="background:#ED8323;"></a>
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('traveler') }}/user-profile.html">User Profile</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ url('traveler') }}/user-profile-booking-history.html">Booking History</a>
                                        </li>
                    ...
                    <table class="table table-bordered table-striped table-booking-history">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center"><a class="btn btn-default btn-sm" href="{{ url('traveler') }}/#">Cancel</a>
                                </td>
                            </tr>
                            <tr>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-booking-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 21:31:37 GMT -->
</html>
