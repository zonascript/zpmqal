...
@section('content')
  <div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
      <a href="{{ url('dashboard/manage/location/country/') }}" class="btn btn-primary btn-block">Back</a>
    </div>
  </div>
  <div class="row">
                ...
                <div class="well col-md-12 col-sm-12 col-xs-12 profile_view">
                  ...
                  <div class="col-xs-12 bottom text-center">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      <a href="{{ url('dashboard/manage/location/country/'.$user->email.'/edit') }}" class="btn btn-success btn-block"><i class="fa fa-edit"></i> Update Profile</a>
                    </div>
