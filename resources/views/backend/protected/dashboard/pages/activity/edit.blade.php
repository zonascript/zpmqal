			...
			<div class="x_content">
				...
				{{-- <form class="form-horizontal form-label-left input_mask"> --}}
					<div class="form-group">
						<div class="col-md-3 col-sm-3 col-xs-12">
							<select class="select2_single form-control countries">
								...
								@foreach ($countries as $country)
									<option value="{{ $country->fgf_countrycode }}|{{ $country->currencyCode }}" {{ $activity->countryCode == $country->fgf_countrycode ? 'selected' : '' }}>{{ $country->country }}</option>
								@endforeach
							</select>
						</div>
						<div class="col-md-3 col-sm-3 col-xs-12">
							<select class="select2_single form-control destinations">
								<option value="{{ isset($activity->location->fgf_destinationcode) ? $activity->location->fgf_destinationcode : ''}}">{{ isset($activity->location->destination) ? $activity->location->destination : 'Select' }}</option>
							</select>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-12">
							<select class="select2_single form-control currency">
								...
								@foreach ($countries as $country)
									<option value="{{ $country->currencyCode }}" {{ $activity->currency == $country->currencyCode ? 'selected' : '' }}>{{ $country->currency }} ({{ $country->currencyCode }})</option>
								@endforeach
							</select>
						</div>

						<div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
							<input type="text" class="span2 form-control has-feedback activityValidFrom" id="fromDate" data-date-format="dd/mm/yyyy" placeholder="ValidFrom" value="{{ date_formatter($activity->fromDate, 'Y-m-d', 'd/m/Y') }}" required="">
							<i class="fa fa-calendar form-control-feedback right" aria-hidden="true"></i>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
							<input type="text" class="span2 form-control has-feedback activityValidTo" id="toDate" data-date-format="dd/mm/yyyy" placeholder="ValidTo" value="{{ date_formatter($activity->toDate, 'Y-m-d', 'd/m/Y') }}" required="">
							<i class="fa fa-calendar form-control-feedback right" aria-hidden="true"></i>
						</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback m-top-10">
						<input type="text" class="form-control has-feedback-left activityName" id="inputSuccess2" placeholder="Activity Name" value="{{ $activity->name}}">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
											<input type="text" class="form-control has-feedback-left sic-adultPrice" id="inputSuccess2" placeholder="Adult Cost" value="{{ $activity->adultTktSic }}">
											<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
											<input type="text" class="form-control has-feedback-left sic-childPrice" id="inputSuccess2" placeholder="Child (2 > 12)" value="{{ ifset($activity->childCharges->SIC->child) }}">
											<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
											<input type="text" class="form-control has-feedback-left sic-infantPrice" id="inputSuccess2" placeholder="Infant (0 > 2)" value="{{ ifset($activity->childCharges->SIC->infant) }}">
											<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
										</div>
									</div>
								</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 m-top-10">
							<div class="col-md-12 col-sm-12 col-xs-12 border-gray m-top-10">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
										<input type="text" class="form-control has-feedback-left private-adultPrice" id="inputSuccess2" placeholder="Adult Cost" value="{{ $activity->adultPrice }}">
										<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
									</div>
									<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
										<input type="text" class="form-control has-feedback-left private-childPrice" id="inputSuccess2" placeholder="Child (2 > 12)" value="{{ ifset($activity->childCharges->Private->child) }}">
										<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
									</div>
									<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
										<input type="text" class="form-control has-feedback-left private-infantPrice" id="inputSuccess2" placeholder="Infant (0 > 2)" value="{{ ifset($activity->childCharges->Private->infant) }}">
										<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
									</div>
									</div>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div id="activityCarDiv">
										@foreach ($activity->cars as $carKey => $carValue)
											<div id="activityCar_{{ $carKey+1 }}" class="row activity-car-inner">
												<div class="col-md-12 col-sm-12 col-xs-12"><h2>Car {{ $carKey+1 }}</h2></div>
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<input type="text" class="form-control has-feedback-left carName" id="inputSuccess2" placeholder="Car Name" value="{{ $carValue->carName }}">
													<i class="fa fa-car form-control-feedback left" aria-hidden="true"></i>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<input type="text" class="span2 dpdStart_{{ $carKey+1 }} carStartDate form-control has-feedback carValidFrom" id="fromDate" data-date-format="dd/mm/yyyy" placeholder="From" value="{{ date_formatter($carValue->fromDate, 'Y-m-d', 'd/m/Y') }}" required="">
													<i class="fa fa-calendar form-control-feedback right" aria-hidden="true"></i>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<input type="text" class="span2 dpdEnd_{{ $carKey+1 }} carEndDate form-control has-feedback carValidTo" id="toDate" data-date-format="dd/mm/yyyy" placeholder="To" value="{{ date_formatter($carValue->toDate, 'Y-m-d', 'd/m/Y') }}" required="">
													<i class="fa fa-calendar form-control-feedback right" aria-hidden="true"></i>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12">
													<select class="select2_single form-control carCapcity">
														...
														@for ($i = 4; $i <= 8 ; $i++)
															<option value="{{ $i }}" {{ $i == $carValue->capacity ? 'selected' : '' }}>{{ $i }} Seater</option>
															<?php ++$i; ?>
														@endfor
													</select>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<input type="text" class="form-control has-feedback-left carPrice" id="inputSuccess2" placeholder="Price" value="{{ $carValue->price }}">
													<i class="fa fa-money form-control-feedback left" aria-hidden="true"></i>
												</div>
											</div>
										@endforeach
							...
							<div class="col-md-12 col-sm-12 col-xs-12 border-gray m-top-10">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div id="activityTiming">
										@foreach ($activity->timing as $timingKey => $timingValue)
											<div id="activityTiming_{{ $timingKey+1 }}" class="row activity-timing">
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<label for="">Opening Time</label>
													<input type="text" class="form-control has-feedback-left datetimepicker opening-time" id="inputSuccess2" placeholder="Opening Time" value="{{ substr($timingValue->openingTime, 0, 5) }}">
													<i class="fa fa-clock-o form-control-feedback left" aria-hidden="true"></i>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<label for="">Duration</label>
													<input type="text" class="form-control has-feedback-left datetimepicker duration" id="inputSuccess2" placeholder="Duration" value="{{ substr($timingValue->duration, 0, 5) }}">
													<i class="fa fa-clock-o form-control-feedback left" aria-hidden="true"></i>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
													<label for="">Closing Time</label>
													<input type="text" class="form-control has-feedback-left datetimepicker closing-time" id="inputSuccess2" placeholder="Closing Time" value="{{ substr($timingValue->closingTime, 0, 5) }}">
													<i class="fa fa-clock-o form-control-feedback left" aria-hidden="true"></i>
												</div>
											</div>
										@endforeach
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<textarea class="form-control activity-Description" rows="5">{{ $activity->description }}</textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						{{-- <label class="col-md-12 col-sm-12 col-xs-12 m-top-10">Activity Images<span class="required">*</span>
						</label>
					...
					<div class="form-group">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="col-md-3 col-sm-3 col-xs-12 m-tb-10px">
