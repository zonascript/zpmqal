			...
			<div class="center">
				<div class="input-group">
					...
					<span class="form-control text-center nopadding-right">
						<input type="text" id="count_adult_1" class="width-10 nostyle adults" value="2" data-min="1" data-max="4" data-singular="Adult" data-plural="Adults">
						<span>Adults</span>
					</span>
					<span class="input-group-btn">
		...
		<div class="col-md-3 col-sm-3 col-xs-12 p-bottom-1 m-bottom-n-5 form-group has-feedback">
			<div class="center">
				<div class="input-group">
					...
					<span class="form-control text-center nopadding-right">
						<input type="text" id="count_child_1" class="width-10 nostyle children" value="0" data-min="0" data-max="2" data-singular="Child" data-plural="Children">
						<span>Child</span>
					</span>
					<span class="input-group-btn">
