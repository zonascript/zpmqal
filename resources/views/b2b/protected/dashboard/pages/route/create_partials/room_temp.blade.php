<div id="room_'+count+'" class="room-guest inctv" data-id="">
	<div class="row">
			...
			<div class="center">
				<div class="input-group">
					<span class="input-group-btn">
						<button type="button" class="btn btn-default btn-number noradius bg-color-gray btn-decrease" field="#count_adult_'+count+'">
					...
					<span class="input-group-btn">
						<button type="button" class="btn btn-default btn-number noradius bg-color-gray m-right-0 btn-increase" field="#count_adult_'+count+'">
		...
		<div class="col-md-3 col-sm-3 col-xs-12 p-bottom-1 m-bottom-n-5 form-group has-feedback">
			<div class="center">
				<div class="input-group">
					<span class="input-group-btn">
						<button type="button" class="btn btn-default btn-number noradius bg-color-gray btn-decrease btn-child" field="#count_child_'+count+'">
							<span class="glyphicon glyphicon-minus"></span>
						</button>
					</span>
					<span class="form-control text-center nopadding-right">
					...
					<span class="input-group-btn">
						<button type="button" class="btn btn-default btn-number noradius bg-color-gray m-right-0 btn-increase btn-child" field="#count_child_'+count+'">
							<span class="glyphicon glyphicon-plus"></span>
						</button>
					</span>
				</div>				
