						...
						<div class="x_title" >
							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-4 col-xs-4">
									<b id="show_room_guests"></b>
									<button id="btn_room_guests" class="form-control text-right" type="button">
										<span class="pull-left" style="color: #555;">Guests : </span>
										<span class="guests-word" style="color: #555;"></span>
...
@section('scripts')
	...
	@include($viewPath.'.create_partials.room_popup')
@endsection
