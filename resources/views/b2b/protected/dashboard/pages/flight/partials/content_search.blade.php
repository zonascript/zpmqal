				...
				<div class="x_content nopadding">
					<div class="form-group">
						<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback m-top-10-only">
							<input type="text" class="form-control input-airport origin" id="inputSuccess3" placeholder="Origin" name="origin" value="{{ $requestData->origin }}">
							<i class="fa fa-map-marker form-control-feedback right-1 right" aria-hidden="true"></i>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback m-top-10-only">
							<input type="text" class="form-control input-airport destination" id="inputSuccess3" placeholder="Destination" name="destination" value="{{ $requestData->destination }}">
							<i class="fa fa-map-marker form-control-feedback right-1 right" aria-hidden="true"></i>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback m-top-10-only">
							<input type="text" class="form-control has-feedback-left datepicker p-left-10 arrival" placeholder="Arrival" aria-describedby="inputSuccess2Status3" name="arrival" value="{{ $requestData->arrival }}" disabled="">
