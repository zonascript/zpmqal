@if (isset($hotelRoom->tbtq->rooms->GetHotelRoomResult) && $hotelRoom->tbtq->rooms->GetHotelRoomResult->ResponseStatus == 1)
<?php $imageIndex = 0; ?>
@forelse ($hotelRoom->tbtq->rooms->GetHotelRoomResult->HotelRoomsDetails as $hotelRoom_key => $hotelRoom_value)
	<?php 
		$imageCount = count($hotelRoom->tbtq->detail->HotelInfoResult->HotelDetails->Images); 
			...
			<div class="col-md-2 col-sm-2 col-xs-12 nopadding">
				<div class="m-top-10">
					<div class="col-md-12 col-sm-12 col-xs-12 pull-right">
						...
						<div class="m-top-20">
							<button class="btn btn-block btn-primary btn-bookRoom" data-bookIndex="{{ $hotelRoom_key }}" data-vendor="tbtq">Book</button>
						</div>
					</div>
				</div>
			</div>
