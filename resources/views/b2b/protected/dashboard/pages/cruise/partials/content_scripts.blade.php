...
<script>
	$(document).on('click','.btn-chooseRoom', function(){
		...
		var cruiseIndex = $(this).attr('data-cruiseIndex');
		var visibleHotelDetailId = $('.classHotelDetail:visible').attr('id');
		var visibleHotelDetailId = $('.classHotelDetail:visible').attr('id');
		var currntHotelDetailId = 'hoteldetail-'+cruiseIndex;
		var currntHotelRoomlId = 'roomresult-'+cruiseIndex;
		...
		if(isVisible){
			...
			$.ajax({
				type:"post",
				url: "{{ urlCruisesCabinBuilder($urlVariable->id, $urlVariable->packageDbId, $urlVariable->packageCrusiesId) }}",
				data: data,
...
<script>
	$(document).on('click', '.btn-bookRoom', function(){
		...
		$.ajax({
			type:"post",
			url: "{{ urlCruisesCabinBookBuilder($urlVariable->id, $urlVariable->packageDbId, $urlVariable->packageCrusiesId) }}",
			data: data,
			success: function(responce, textStatus, xhr) {
