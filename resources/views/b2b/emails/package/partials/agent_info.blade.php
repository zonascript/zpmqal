	...
	<tbody>
		<tr>
			<td align="center" bgcolor="{{ $theme->color }}" valign="middle">
				...
				<br>
				<br> <span style="font-size:13px;font-family:Arial;font-weight:normal">Direct: <span style="color:red"> <span>
				<a href="tel:{{ $agentCont }}" value="+91{{ $agentCont }}" target="_blank">+91 {{ $agentCont }}</a>
				</span>
				</span>
				</span>
				<br>
				<span style="font-size:13px;font-family:Arial;font-weight:normal">Tel: <span style="color:red">
				<span>
